...
import com.Bai1.identity_service.exception.ErrorCode;
import com.Bai1.identity_service.mapper.UserMapper;
...
public class UserService {
    ...
    public UserResponse updateUser(String useId, UserUpdateRequest request) {
        User user = userRepository.findById(useId).orElseThrow(() -> new RuntimeException("User  not found"));
